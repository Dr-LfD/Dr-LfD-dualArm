...
def plan_workspace_motion(
    ...
    # for joint_id, joint_name in zip(ik_joints, ik_joint_names):
    ...
    for attempts in range(max_attempts):
        ...
        # ):        
            ...
            if collision_fn(arm_conf, verbose=True):
                continue
            ...
            for i_wp, tool_pose in enumerate(tool_waypoints[1:]):
                ...
                if len(arm_path) <=2:
                    print("If not Dropping, rrm path is too short!")
                    # continue
