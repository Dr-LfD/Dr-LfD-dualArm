...
def resolve_workspace_root(current_file):
    ...
    raise ValueError(
        ...
        "expected path to contain 'pddlstream_aloha'."
    )
...
if __name__ == "__main__":
    ...
    CONTACT_REPO = "/home/xuhang/Desktop/yzchen_ws/ContactPrediction"
    # CHECKPOINT = "/home/xuhang/Desktop/yzchen_ws/ContactPrediction/data/outputs/2026.05.11/14.45.50_train_keypose_transformer_handoff_cup_multi_edge_wristview/checkpoints/latest.ckpt"
    # CONTACT_EDGE = "right_arm_cup"
    CHECKPOINT = "/home/xuhang/Desktop/yzchen_ws/ContactPrediction/data/outputs/2026.05.19/11.39.08_train_keypose_transformer_screwdriver_multi_edge_wristview/checkpoints/latest.ckpt"
