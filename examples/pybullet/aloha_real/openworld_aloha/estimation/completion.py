...
from  examples.pybullet.aloha_real.openworld_aloha.estimation.bounding import get_trimesh_oobb
from  examples.pybullet.aloha_real.openworld_aloha.estimation.observation import aggregate_color
from examples.pybullet.aloha_real.openworld_aloha.estimation.lis import SC_PATH
...
def refine_shape(sc_network, points, num_refine=None, use_points=True, min_z=0.0, **kwargs):
    assert sc_network is not None
    import torch
