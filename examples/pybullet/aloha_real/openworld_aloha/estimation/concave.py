...
from examples.pybullet.aloha_real.openworld_aloha.estimation.clustering import has_open3d
from examples.pybullet.aloha_real.openworld_aloha.estimation.lis import USING_ROS
...
def query_concave_server(points, alpha=DEFAULT_ALPHA, **kwargs):
    ...
    from examples.pybullet.aloha_real.openworld_aloha.real_world.ros_utils import (
