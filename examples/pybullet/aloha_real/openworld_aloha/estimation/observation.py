...
from examples.pybullet.utils.pybullet_tools.voxels import MAX_PIXEL_VALUE

from examples.pybullet.aloha_real.openworld_aloha.entities import TABLE, UNKNOWN, Object, LabeledPoint
...
def save_camera_images(
    ...
    depth_image_save = depth_image.astype(np.uint8)
    save_image(
        os.path.join(directory, "{}depth.png".format(prefix)), depth_image_save
    )  # [0, 1]
