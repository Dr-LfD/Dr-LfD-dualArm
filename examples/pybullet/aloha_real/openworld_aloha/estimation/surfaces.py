...
def ransac_estimate_plane(
    ...
    # from examples.pybullet.aloha_real.openworld_aloha.retired import estimate_pcl_plane
    assert batch_size >= 3
...
def surface_point_filter(surface, labeled_points, min_z=1e-3):
    # from examples.pybullet.utils.pybullet_tools.utils import is_point_on_surface
